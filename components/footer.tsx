...
const navigation = {
  ...
  services: [
    ...
    { name: "Vehicle Insurance", href: "/services#vehicle" },
    { name: "Business Insurance", href: "/services#business" },
    { name: "Travel Insurance", href: "/services#travel" },
  ],
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://linkedin.com/company/procareinsurance"
                target="_blank"
                rel="noopener noreferrer"
                className="h-10 w-10 rounded-full bg-background/10 flex items-center justify-center hover:bg-primary transition-colors"
                aria-label="LinkedIn"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="h-10 w-10 rounded-full bg-background/10 flex items-center justify-center hover:bg-secondary transition-colors"
                aria-label="WhatsApp"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+94112345678" className="text-sm text-background/70 hover:text-background transition-colors">
                  +94 11 234 5678
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-5 w-5 text-primary shrink-0" />
                <a href="mailto:info@procareinsurance.lk" className="text-sm text-background/70 hover:text-background transition-colors">
                  info@procareinsurance.lk
                </a>
              </li>
            </ul>
          </div>
